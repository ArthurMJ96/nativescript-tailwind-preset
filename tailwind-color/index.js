...
const resolveConfig = (config = {}) => {
  ...
  ;(0, lodash_foreach_1.default)(configObject, (colors, themeName) => {
    ...
    ;(0, lodash_foreach_1.default)(flatColors, (colorValue, colorName) => {
      ...
      const [h, s, l, defaultAlphaValue] = (0, color_1.default)(colorValue)
        .hsl()
        .round()
        .array()
      ...
      if (typeof defaultAlphaValue === 'number') {
        resolved.utilities[cssSelector][twcOpacityVariable] =
          defaultAlphaValue.toFixed(2)
      }
      // set the dynamic color in tailwind config theme.colors
      resolved.colors[colorName] = ({ opacityVariable, opacityValue }) => {
        // if the opacity is set  with a slash (e.g. bg-qlsihdk/90), use the provided value
